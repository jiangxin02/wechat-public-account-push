...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx8c4c6583ef1e6628',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '6ba14bed54d835ed4fc3f38233119752',
   ...
   */
  USERS: ['oRDXL59B_k7Td2xZCTwMKhSF-eyQ'],
    {
      // 想要发送的人的名字
      name: '老婆大人',
      ...
      id: '蒋鑫',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'rnVH-taqqEz_S4X9e1SdDJIAU83whrJ-XZYi6mu-wzE',
      // 所在省份
      province: '重庆',
      // 所在城市
      city: '重庆',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '1999', date: '08-29',
        },
        {
          type: '节日', name: '结婚纪念日', year: '2022', date: '06-01',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '老婆', year: '1999', date: '07-19',
        },
        {
